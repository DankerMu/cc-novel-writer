...
**说明**：步骤 1c 的 storylines 初始化默认最小化——仅创建一条 type 为 `main_arc` 的主线。用户可在后续卷规划时通过 PlotArchitect 逐步增加副线/暗线，无需在快速起步阶段定义完整的故事线体系。同时活跃故事线建议 ≤ 4 条 [DR-021](../../v5/dr/dr-021-llm-multi-thread-narrative.md)。
